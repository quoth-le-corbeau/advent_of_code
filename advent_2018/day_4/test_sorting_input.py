...
def test_sorting_records():
    with open(pathlib.Path(__file__).parent / "unsorted.txt", "r") as unsorted_eg:
        lines = unsorted_eg.read().splitlines()
        print(sorted(lines))
    with open(pathlib.Path(__file__).parent / "eg.txt", "r") as eg_file:
        eg_lines = eg_file.read().splitlines()
        print(eg_lines)
    assert sorted(lines) == eg_lines
    with open(pathlib.Path(__file__).parent / "input.txt", "r") as real_input:
        real_lines = real_input.read().splitlines()
        print(sorted(real_lines))
